                    ...
                    <div class="profile-cta">
                        ...
                        <div class="cta-modal">
                            <div class="cta-options" style="text-align: center;">
                                <a href="evacueesForm.php">Edit</a>
                                <a href="evacueesForm.php">Transfer</a>
                                <a href="#">Move out</a>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="evacueesProfile">
                            ...
                            <div class="profileInfo-right">
                                ...
                                <div class="profile-details">
                                    ...
                                    <p class="details-profile">Sex: Male</p>
                                    <p class="details-profile">Birth date: November 15, 2001 </p>
                        ...
                        <div class="eprofileLog">
                            ...
                            <div class="data">
                                ...
                                <div class="log-container">
                                    ...
                                    <div class="logDivider"></div>
                                    <p class="logInfo">Info here chuchu chuchu chu</p>
                                </div>

                                <div class="log-container">
                                    <p class="logDate">11-15-2024</p>
                                    <div class="logDivider"></div>
                                    <p class="logInfo">Info here</p>
                                </div>
                                ...
                                <div class="log-container">
                                    <p class="logDate">11-28-2024</p>
                                    <div class="logDivider"></div>
                                    <p class="logInfo">Ayuda pack received</p>
                                </div>
                            </div>
                        </div>
                    </div>
